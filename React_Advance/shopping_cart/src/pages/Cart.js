		...
		<div className="min-h-[80vh] flex flex-col items-center justify-center">
			{cart.length > 0 ? (
				...
				<div className="flex w-full h-full flex-col items-center justify-center">
					<h1 className="text-gray-700 font-semibold text-2xl mb-2">
						Your Cart is Empty!
					</h1>
					<NavLink to="/">
						<button className="bg-green-600 hover:bg-purple-50 rounded-lg text-white transition duration-300 ease-linear mt-5 border-2 border-green-600  hover:text-green-700 p-3 px-10 tracking-wider font-bold">
							Shop Now
						</button>
					</NavLink>
				</div>
